...
public class HomeScreenActiveAccountCases extends SetupConnection {
	...
	public void profileHeaderIsVisible () {
	    ...
	    wait.until(ExpectedConditions.presenceOfElementLocated(By.id("com.myxfitness.app:id/profileHeader")));
	...
	public void bikeFilterIsVisible () {
		...
		//ELEMENT IS DISPLAYED
		SoftAssert visualAssertion= new SoftAssert();
		visualAssertion.assertEquals(true, driver.findElementById("com.myxfitness.app:id/header_bike").isDisplayed());		
	...
	public void floorFilterIsVisible () {
		...
		//ELEMENT IS DISPLAYED
		SoftAssert visualAssertion= new SoftAssert();
		visualAssertion.assertEquals(true, driver.findElementById("com.myxfitness.app:id/header_floor").isDisplayed());		
	...
	public void recoveryFilterIsVisible () {
		...
		//ELEMENT IS DISPLAYED
		SoftAssert visualAssertion= new SoftAssert();
		visualAssertion.assertEquals(true, driver.findElementById("com.myxfitness.app:id/header_mindful").isDisplayed());		
	...
	public void crossTrainingFilterIsVisible () {
		...
		//ELEMENT IS DISPLAYED
		SoftAssert visualAssertion= new SoftAssert();
		visualAssertion.assertEquals(true, driver.findElementById("com.myxfitness.app:id/header_myxplus").isDisplayed());		
	...
	public void myxMediaIsVisible () {
		...
		//ELEMENT IS DISPLAYED
		SoftAssert visualAssertion= new SoftAssert();
		visualAssertion.assertEquals(true, driver.findElementById("com.myxfitness.app:id/header_media").isDisplayed());		
	...
	public void smartMYXIsVisible () {
		...
		//ELEMENT IS DISPLAYED
		SoftAssert visualAssertion= new SoftAssert();
		visualAssertion.assertEquals(true, driver.findElementById("com.myxfitness.app:id/smart_myx").isDisplayed());		
	...
	public void calendarIsVisible () {
		...
		//ELEMENT IS DISPLAYED
		SoftAssert visualAssertion= new SoftAssert();
		visualAssertion.assertEquals(true, driver.findElementById("com.myxfitness.app:id/schedules").isDisplayed());		
	...
	public void myxLogoIsVisible () {
		...
		//ELEMENT IS DISPLAYED
		SoftAssert visualAssertion= new SoftAssert();
		visualAssertion.assertEquals(true, driver.findElementById("com.myxfitness.app:id/ivMyxLogo").isDisplayed());		
